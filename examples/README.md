...
| BF16-to-GGUF deployment | `make example-gguf-deployment` | One pinned Qwen3.5 9B checkpoint executed as BF16 with Transformers and as a reproducibly derived Q5_K_M GGUF with llama.cpp |
