#!/usr/bin/env python3
"""Prepare a tiny HF checkpoint and fixture for the hf_quanto example."""
...
"""
    ...
    summary: dict[str, object] = {
        "format_version": "quanto-fixture-v1",
    ...
    *,
    ...
    if output_dir.exists():
        if force:
            ...
            return {
                "format_version": "quanto-model-v1",
...
def write_adapter_runtime_summary(
    ...
    *,
    ...
    summary = {
        "format_version": "quanto-adapter-runtime-v1",
...
def write_checkpoint_refs(output_dir: Path, *, model_dir: Path) -> dict[str, object]:
    refs = {
        "format_version": "quanto-checkpoint-refs-v1",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "the hf_quanto integration example."
        )
    )
