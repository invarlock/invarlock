...
Materialize a tiny one-step fine-tuned subject checkpoint, then compare it
...
Options:
  ...
  --subject-dir DIR            Output directory for the fine-tuned subject.
                               Default: examples/integrations/fine_tune/models/tiny-gpt2-fine-tuned
  --fixture-dir DIR            Generated local JSONL/preset directory.
                               Default: examples/integrations/fine_tune/artifacts/tiny-fine-tune-fixture
  --report-out DIR             Output directory for InvarLock artifacts.
                               Default: examples/integrations/fine_tune/reports/tiny-fine-tune/<artifact-lane>
...
materialize_cmd=(
  "$PYTHON_BIN"
  "$SCRIPT_DIR/materialize_tiny_fine_tune_subject.py"
  --baseline "$baseline"
