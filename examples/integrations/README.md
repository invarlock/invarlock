...
| [BF16-to-GGUF deployment](gguf-deployment/) | `make example-gguf-deployment` | One pinned Qwen3.5 9B source executed through Transformers/CUDA and a derived Q5_K_M GGUF through llama.cpp/CPU |
