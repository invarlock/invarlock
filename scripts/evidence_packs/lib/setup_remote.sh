...
# Usage:
#   scp scripts/evidence_packs/lib/setup_remote.sh root@<host>:/root/
...
main() {
    ...
    log "Setup complete. Run INVARLOCK_ALLOW_REMOTE_CODE=1 ./scripts/evidence_packs/run_pack.sh --suite subset --net 1"
}
