...
Runs the maintained Qwen2.5-14B proof-pack sentinels from an existing proof-pack
run directory:
...
Options:
  --run-dir DIR       Existing proof-pack run directory
  --model-name NAME   Sanitized proof-pack model directory name
