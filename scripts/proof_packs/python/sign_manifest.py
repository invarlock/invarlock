...
from invarlock.proof_pack_integrity import (
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Sign a proof-pack manifest with a package-native Ed25519 key."
    )
    parser.add_argument(
        "--manifest",
        required=True,
...
def main(argv: list[str] | None = None) -> int:
    ...
    with TemporaryDirectory(prefix="invarlock-proof-pack-signing-") as tmp_dir:
