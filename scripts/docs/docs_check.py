...
try:
    from scripts.docs import docs_claim_surface as _claim_surface
except ImportError:  # pragma: no cover - direct script execution path
    import docs_claim_surface as _claim_surface

CLAIM_BANNED_BY_FILE = _claim_surface.CLAIM_BANNED_BY_FILE
CLAIM_REQUIRED_BY_FILE = _claim_surface.CLAIM_REQUIRED_BY_FILE
_check_claim_surface_consistency = _claim_surface.check_claim_surface_consistency
...
def check_claim_surface_consistency() -> int:
    return _check_claim_surface_consistency(root=repo_root(), read_text=read_text)
