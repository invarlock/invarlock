"""Preparation helpers for config-driven run orchestration execution."""
...
from invarlock.core.run_execution_context_policy import (
    build_run_context_payload as _build_run_context_payload_default,
)
from invarlock.core.run_execution_context_policy import (
    build_run_execution_config_payloads as _build_run_execution_config_payloads_default,
)
...
from invarlock.core.run_policy import (
    resolve_guard_overhead_threshold as _resolve_guard_overhead_threshold_default,
)
from invarlock.core.run_policy import (
    resolve_pm_acceptance_range as _resolve_pm_acceptance_range_default,
)
from invarlock.core.run_policy import (
    resolve_pm_drift_band as _resolve_pm_drift_band_default,
)
from invarlock.core.run_policy import (
...
def _resolve_loss_seed_and_determinism_state(
    ...
    *,
    ...
    try:
        numpy_mod = getattr(_execute_helpers_module, "np", np)
        numpy_state = cast(tuple[Any, ...], numpy_mod.random.get_state())
...
def _resolve_run_components(
    *,
    ...
    resolve_pm_acceptance_range_fn = getattr(
        _execute_helpers_module,
        "_resolve_pm_acceptance_range_impl",
        _resolve_pm_acceptance_range_default,
    )
    resolve_pm_drift_band_fn = getattr(
        _execute_helpers_module,
        "_resolve_pm_drift_band_impl",
        _resolve_pm_drift_band_default,
    )
    resolve_guard_overhead_threshold_fn = getattr(
        _execute_helpers_module,
        "_resolve_guard_overhead_threshold_impl",
        _resolve_guard_overhead_threshold_default,
    )
    build_run_context_payload_fn = getattr(
        _execute_helpers_module,
        "_build_run_context_payload_impl",
        _build_run_context_payload_default,
    )
...
def _prepare_execution_state(
    *,
    ...
    build_run_execution_config_payloads_fn = getattr(
        _execute_helpers_module,
        "_build_run_execution_config_payloads_impl",
        _build_run_execution_config_payloads_default,
    )
