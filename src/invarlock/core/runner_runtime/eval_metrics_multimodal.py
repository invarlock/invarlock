...
def _portable_replay_reference(value: Any) -> str | None:
...
def _replay_input_record(batch: dict[str, Any], *, example_id: str) -> dict[str, Any]:
    ...
    for key in (
        ...
        if value is not None:
            record[key] = value
    image_ref = _portable_replay_reference(batch.get("image_ref"))
    ...
    source_ref = _portable_replay_reference(batch.get("source_ref"))
...
def _evaluate_vision_text_arm(
    ...
    *,
    ...
    processor_identity: dict[str, str] | None = None
    latency_ms = 0.0
    ...
    for batch in batches:
        ...
        if processor_identity is None:
            candidate_identity = generation_inputs.get("_processor_identity")
        ...
        records.append(
            {
                ...
                "dataset_record_sha256": batch.get("dataset_record_sha256"),
                "materialization_digest": batch.get("materialization_digest"),
                "manifest_sha256": batch.get("manifest_sha256"),
                "record_sha256": batch.get("record_sha256"),
            }
        )
    ...
    if processor_identity:
        payload["processor_identity"] = processor_identity
    ...
    *,
    ...
    eval_windows = {
        "preview": {
            ...
            "processor_identity": preview_payload.get("processor_identity"),
        },
        "final": {
            ...
            "processor_identity": final_payload.get("processor_identity")
            or preview_payload.get("processor_identity"),
        },
    }
