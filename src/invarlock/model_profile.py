...
from invarlock import model_profile_profiles as profile_defs
...
ModelProfile = profile_defs.ModelProfile
detect_model_profile = profile_defs.detect_model_profile
