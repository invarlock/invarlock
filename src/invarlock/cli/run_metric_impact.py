"""Guard-metric-impact and release-window planning helpers."""
...
_METRIC_IMPACT_EXTRACTION_ERRORS = (
    AttributeError,
    KeyError,
    RuntimeError,
    TypeError,
...
def _extract_pm_snapshot_for_metric_impact(
    src: object, *, kind: str
) -> dict[str, Any] | None:
    ...
    try:
        ...
        if isinstance(metrics, dict):
            ...
            if snapshot is not None:
                return snapshot
    except _METRIC_IMPACT_EXTRACTION_ERRORS:
        pass
