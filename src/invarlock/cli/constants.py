...
DOCTOR_FORMAT_VERSION = DOCTOR_OUTPUT_FORMAT_VERSION
PLUGINS_FORMAT_VERSION = PLUGINS_OUTPUT_FORMAT_VERSION
VERIFY_FORMAT_VERSION = VERIFY_OUTPUT_FORMAT_VERSION
RUNTIME_VERIFY_FORMAT_VERSION = RUNTIME_VERIFY_OUTPUT_FORMAT_VERSION
POLICY_PACK_VERIFY_FORMAT_VERSION = POLICY_PACK_VERIFY_OUTPUT_FORMAT_VERSION
EVIDENCE_PACK_VERIFY_FORMAT_VERSION = EVIDENCE_PACK_VERIFY_OUTPUT_FORMAT_VERSION
EVIDENCE_PACK_INSPECT_FORMAT_VERSION = "evidence-pack-inspect-v1"
EVIDENCE_PACK_SET_VERIFY_FORMAT_VERSION = "evidence-pack-set-verify-v1"
EVIDENCE_CATALOG_VALIDATE_FORMAT_VERSION = (
    EVIDENCE_CATALOG_VALIDATE_OUTPUT_FORMAT_VERSION
)
CATALOG_INPUT_MATERIALIZE_FORMAT_VERSION = "catalog-input-materialize-v1"
CATALOG_INPUT_PREPARE_FORMAT_VERSION = "catalog-input-prepare-v1"
