...
def accuracy_from_records(records: Iterable[Any]) -> float:
...
def exact_match_from_records(records: Iterable[Any]) -> float:
...
def bleu1_from_records(records: Iterable[Any]) -> float:
...
def rouge_l_from_records(records: Iterable[Any]) -> float:
