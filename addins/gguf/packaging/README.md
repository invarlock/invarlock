...
[`runtime/Dockerfile`](https://github.com/invarlock/invarlock/blob/v0.16.1/addins/gguf/runtime/Dockerfile), not in an ordinary host process:
...
class; see the [canary compatibility rules](https://github.com/invarlock/invarlock/blob/v0.16.1/docs/reference/runtime-providers.md).
