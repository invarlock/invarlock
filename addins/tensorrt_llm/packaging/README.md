...
device class; see the [canary compatibility rules](https://github.com/invarlock/invarlock/blob/v0.15.0/docs/reference/runtime-providers.md).
...
[`runtime/Dockerfile`](https://github.com/invarlock/invarlock/blob/v0.15.0/addins/tensorrt_llm/runtime/Dockerfile), with the target GPU available:
