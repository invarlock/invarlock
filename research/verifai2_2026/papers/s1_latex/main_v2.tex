...
Appendix~\ref{app:fulltable}. ``capped'' means spectral family caps were applied
...
\small
\input{tables/s1_demo_full_table.tex}
...
\centering
\scriptsize
\input{tables/file_inventory.tex}
\caption{Inventory of named files referenced by this paper (SHA-256 prefixes shown for compactness).}
\end{table}
