...
Experiment trackers (e.g., MLflow \citep{mlflow}, W\&B) log metrics and artifacts but do not enforce a closed
...
A condensed artifact skeleton (ellipses indicate omitted substructures) is:
\begin{lstlisting}
{
  "schema_version": "verifier_carrying_artifact.v1",
  "provenance": { ... },
  "guard_evidence": { "invarlock": { "evaluation_report": { "sha256": "..." } } },
  "verifier_traces": [
    { "schema_version": "verifier_trace.v1",
      "verifier": { "kind": "code_execution", ... },
      "trace_contract": { "prompt_set": { "digest_sha256": "..." }, ... },
      "results": { "summary": { "pass_rate": 0.0 }, "cases": [ ... ] } }
  ]
}
\end{lstlisting}
