...
def test_evaluate_finalize_state_suppresses_no_scaling_warning_only_for_noop() -> None:
    common = {
        "should_enable": False,
        "enabled_after_ab": False,
        "gate_reason": "not_needed",
        ...
        "required_gain_with_deadband": 0.1,
        "absolute_floor": 0.05,
        "calibration_status": "no_scaling_required",
    }

    noop = evaluate_finalize_state(**common, no_adjustment_required=True)
    ordinary = evaluate_finalize_state(**common, no_adjustment_required=False)

    assert noop == {"passed": True, "warnings": [], "errors": []}
