...
from tests.lint._support_architecture_guardrails import (
    METRICS_PATH,
    REPO_ROOT,
    _read_text,
)
...
def test_hardened_runtime_paths_keep_broad_catch_budgets() -> None:
    budgets = {
        ...
        REPO_ROOT / "src/invarlock/adapters/hf_mlm_structure.py": 0,
        REPO_ROOT / "src/invarlock/adapters/hf_mixin.py": 0,
        REPO_ROOT / "src/invarlock/adapters/hf_mixin_snapshot.py": 0,
        REPO_ROOT / "src/invarlock/eval/data_tokenization.py": 0,
        REPO_ROOT / "src/invarlock/eval/data_local.py": 0,
        REPO_ROOT / "src/invarlock/eval/data_hf_providers.py": 0,
        REPO_ROOT / "src/invarlock/eval/bench_runner.py": 0,
        REPO_ROOT / "src/invarlock/eval/metrics_runtime_resources.py": 0,
        ...
        REPO_ROOT / "src/invarlock/model_profile_tokenizers.py": 0,
        ...
        REPO_ROOT / "src/invarlock/guards/invariants_standard.py": 0,
...
def test_hardened_followup_paths_have_no_local_type_ignore_escapes() -> None:
    hardened_paths = (
        ...
        REPO_ROOT / "src/invarlock/adapters/hf_causal_specs.py",
        REPO_ROOT / "src/invarlock/adapters/hf_mlm.py",
        REPO_ROOT / "src/invarlock/adapters/hf_mlm_structure.py",
        REPO_ROOT / "src/invarlock/adapters/hf_mixin.py",
        REPO_ROOT / "src/invarlock/adapters/hf_mixin_snapshot.py",
