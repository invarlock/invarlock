...
class TestMINeuronScores:
    ...
    def test_basic_mi_computation(self):
        ...
        with patch.object(mi_mod, "mutual_info_regression") as mock_mi:
            ...
            scores = mi_mod.mi_neuron_scores(activations, targets)
    ...
    def test_subsampling_large_dataset(self):
        ...
        with patch.object(mi_mod, "mutual_info_regression") as mock_mi:
            with patch("torch.randperm") as mock_randperm:
                ...
                scores = mi_mod.mi_neuron_scores(
                    activations, targets, max_samples=10000
                )
    ...
    def test_custom_max_samples(self):
        ...
        with patch.object(mi_mod, "mutual_info_regression") as mock_mi:
            with patch("torch.randperm") as mock_randperm:
                ...
                scores = mi_mod.mi_neuron_scores(activations, targets, max_samples=500)
    ...
    def test_mi_computation_parameters(self):
        ...
        with patch.object(mi_mod, "mutual_info_regression") as mock_mi:
            ...
            mi_mod.mi_neuron_scores(activations, targets)
