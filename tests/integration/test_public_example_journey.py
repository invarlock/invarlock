...
def test_only_bounded_fixture_receipts_are_unignored() -> None:
    ...
    fixture_receipts = {
        "examples/evaluator-qualification/signed-transactions/deployment-approval-inspect-ai/verification.receipt.json",
        "examples/evaluator-qualification/signed-transactions/deployment-approval-inspect-ai/evidence/providers/baseline/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/deployment-approval-inspect-ai/evidence/providers/subject/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/gemma4-lm-evaluation-harness/verification.receipt.json",
        "examples/evaluator-qualification/signed-transactions/gemma4-lm-evaluation-harness/evidence/providers/baseline/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/gemma4-lm-evaluation-harness/evidence/providers/subject/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/qwen35-inspect-ai/verification.receipt.json",
        "examples/evaluator-qualification/signed-transactions/qwen35-inspect-ai/evidence/providers/baseline/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/qwen35-inspect-ai/evidence/providers/subject/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/qwen35-lm-evaluation-harness/verification.receipt.json",
        "examples/evaluator-qualification/signed-transactions/qwen35-lm-evaluation-harness/evidence/providers/baseline/runtime-provider.receipt.json",
        "examples/evaluator-qualification/signed-transactions/qwen35-lm-evaluation-harness/evidence/providers/subject/runtime-provider.receipt.json",
        "examples/import/baseline/runtime-provider.receipt.json",
        "examples/import/rejected-subject/runtime-provider.receipt.json",
        "examples/import/subject/runtime-provider.receipt.json",
    }
