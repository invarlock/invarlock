...
from invarlock.runtime_providers import hf_vision_text as provider_module
from invarlock.runtime_providers.hf_vision_text import (
...
def test_prepare_open_score_receipt_and_close_lifecycle(
    ...
    assert receipt.plugin.distribution == "invarlock"
