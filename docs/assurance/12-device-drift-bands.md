...
invarlock report --run runs/baseline_cpu --format cert --out runs/baseline_cpu/evaluation.cert.json
...
invarlock report --run runs/baseline_mps --format cert --out runs/baseline_mps/evaluation.cert.json
