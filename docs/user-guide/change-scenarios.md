...
attached as authenticated observations. Observation payloads have no acceptance
authority; the selected scorer and its policy use their own authenticated inputs.
