...
For most evidence readers, the primary artifact is `evaluation.report.json`, not the
...
That layout is intentional: evidence readers should be able to confirm overall status,
...
| `reports/<name>/evaluation_report.md` | Human-friendly summary for evidence readers |
