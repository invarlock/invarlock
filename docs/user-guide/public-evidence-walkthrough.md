...
This walkthrough shows the shipped public evidence floor that evidence readers can
...
Every public evidence artifact carries `evidence.meta.json` so evidence readers can see
...
The GPT-2 lane also ships a small signed pack so evidence readers can exercise the
...
## Export evidence for evidence readers
...
These generated files are reading conveniences. The canonical evidence remains
