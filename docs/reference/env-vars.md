...
| Variable | Default | Purpose |
| --- | --- | --- |
| `INVARLOCK_ALLOW_HOST_EXECUTION` | unset | Advanced/internal host-execution override. Prefer `invarlock evaluate --execution-mode trusted-local` for the public compare/evaluate path. |
