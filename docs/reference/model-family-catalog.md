...
| Gemma 3n E4B image-text LM | `community_experimental` | `google/gemma-3n-E4B-it` | Prepared image-text candidate lane on public VQAv2; audio/video evaluation remains deferred. Public evidence is pending. |
| Gemma 3 4B IT image-text LM | `community_experimental` | `google/gemma-3-4b-it` | Reopened as an image-text candidate through `hf_multimodal` and public VQAv2 rather than a text-only promotion lane. Public evidence is pending. |
