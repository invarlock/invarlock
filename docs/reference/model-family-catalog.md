...
| Gemma 4 E4B image-text LM | `published_basis` | `google/gemma-4-E4B-it` | Public release-profile H100 image-text evidence fixture is included on pinned public VQAv2 materialization. The no-op report passes strict policy with 0.500 final accuracy over 400 examples and no guard warnings. |
| Gemma 4 E2B image-text LM | `published_basis` | `google/gemma-4-E2B-it` | Public release-profile H100 image-text evidence fixture is included on pinned public VQAv2 materialization. The no-op report passes strict policy with 0.388 final accuracy over 400 examples and no guard warnings. |
