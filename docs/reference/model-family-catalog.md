...
| Qwen family aliases (Qwen1.5/Qwen2.5/Qwen3 naming) | `profile_first_class` | `Qwen/Qwen2.5-14B`, `Qwen/Qwen3.5-9B`, `Qwen/Qwen3.5-4B` | Shared qwen-family heuristics cover aliases beyond the declared text-only Qwen2, Qwen2.5 14B, Qwen3, and Qwen3.5 9B public lanes. Qwen3.5 2B now has published image-text evidence through `hf_multimodal` and pinned public VQAv2 materialization; Qwen3.5 4B remains prepared but blocked after strict-prompt H100 sanity reproduced zero exact-answer VQA accuracy. |
