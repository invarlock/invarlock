...
| **Source of truth** | `src/invarlock/core/evaluate_contract.py`, `src/invarlock/core/evaluate_plan.py`, `src/invarlock/reporting/report_builder.py`, `src/invarlock/reporting/report_files.py`, `src/invarlock/cli/commands/evaluate.py`. |
