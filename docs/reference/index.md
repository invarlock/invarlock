...
| [Model Family Catalog](model-family-catalog.md) | Authoritative support inventory and backlog | Evidence readers, tool authors |
| [Public Contracts](contracts.md) | Stable public contracts for reports, verification, and policy artifacts | Tool authors, evidence readers |
...
| [Report Outline](report-outline.md) | Renderer-neutral report information architecture | Renderer authors, evidence readers |
| [Architecture](architecture.md) | System layers, data flow, and dependencies | Builders, evidence readers |
