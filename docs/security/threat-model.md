...
| Replay correctness | Pairing, built-in scores or explicitly authorized scorer results, comparison arithmetic, paired interval, and policy verdict are reconstructed from lower-level facts. |
