...
actual model runs. Start with the [practical change walkthroughs](https://github.com/invarlock/invarlock/blob/v0.16.1/examples/README.md#inspect-a-practical-model-change)
