<p align="center">
  <img
      src="https://raw.githubusercontent.com/invarlock/invarlock/v0.16.2/docs/assets/invarlock-logo.svg"
      alt="InvarLock"
      width="420"
    />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/invarlock/invarlock/blob/v0.16.2/LICENSE"><img alt="License: Apache-2.0" src="https://img.shields.io/badge/license-Apache--2.0-1f3a7a?labelColor=18150f" /></a>
...
the [native local judge example](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/native-local-judge/README.md), or the
[OpenAI-compatible endpoint example](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/openai-compatible-judge/README.md)
...
| --- | --- |
| Check a fine-tune, quantized model or runtime change against a baseline | [Model-change workflows](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/change-scenarios.md) |
| Add a verifiable comparison to an existing evaluator or CI pipeline | [Captured results](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/captured-results.md) |
| Grade frozen answers under a task-specific rubric | [Judge scoring](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/judge-measurements.md) |
| Recheck a hosted service after a change or on a schedule | [Hosted-service requalification](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/hosted-service-requalification.md) |
| Send evidence to a customer or internal release reviewer | [Evidence and verification](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/evidence-and-verification.md) |
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/invarlock/invarlock/v0.16.2/docs/assets/evaluation-verification-flow.svg"
...
[captured-results guide](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/captured-results.md)
...
[CLI reference](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/cli.md)
...
[Evidence sets](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/evidence-sets.md)
...
The [capture guide](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/evaluation-records.md#dedicated-evaluator-exports)
...
The [qualification matrix](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/evaluator-qualification.md)
...
[getting-started guide](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/getting-started.md)
...
[HF runtime group](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/runtime-providers.md#hugging-face-transformers)
after bootstrapping its verified hardened Accelerate wheel.
The [import request](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/request.yaml)
...
actual model runs. Start with the [practical change walkthroughs](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/README.md#inspect-a-practical-model-change)
...
| --- | --- |
| [Native model and runtime comparisons](https://github.com/invarlock/invarlock/tree/v0.16.2/public_evidence) | Pinned text, GGUF, vision-text and TensorRT-LLM comparisons |
| [Evaluator handoffs](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/evaluator-qualification/signed-transactions/README.md) | 400-record Qwen3.5 9B Harness and Inspect journeys; a Gemma instruction-to-QAT comparison |
| [Hosted HTTP capture](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/hosted-service/references/mistral-7b-http/README.md) | 400 paired cases from distinct Mistral 7B base and instruction checkpoints behind a local HTTP service |
| [Likelihood comparison](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/captured-results/references/mistral-7b-likelihood/README.md) | Distinct Mistral 7B checkpoints on 400 fixed narrative continuations |
| [Bounded judge comparison](https://github.com/invarlock/invarlock/blob/v0.16.2/examples/judge-measurements/references/k2-32b-luna-xhigh-heldout/README.md) | 10,260 retained ratings across 1,710 QA and extraction cases, with offline replay |
...
[assurance case](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/assurance/assurance-case.md)
and [trust model](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/security/trust-model.md)
for the precise guarantees and assumptions.

For artifact-delivery automation, optional
[acceptance attestations](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/acceptance-attestations.md)
and [OPA/Rego or CUE policies](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/policy-engine-interop.md)
...
- [Getting started](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/user-guide/getting-started.md) · [Examples](https://github.com/invarlock/invarlock/tree/v0.16.2/examples) · [CLI](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/cli.md) · [Python API](https://github.com/invarlock/invarlock/blob/v0.16.2/docs/reference/api-guide.md)
- [Contributing](https://github.com/invarlock/invarlock/blob/v0.16.2/CONTRIBUTING.md) for development setup and required checks.
...
- [Security policy](https://github.com/invarlock/invarlock/blob/v0.16.2/SECURITY.md) for private vulnerability reports.

Apache-2.0. See [LICENSE](https://github.com/invarlock/invarlock/blob/v0.16.2/LICENSE)
and [third-party notices](https://github.com/invarlock/invarlock/blob/v0.16.2/THIRD_PARTY_NOTICES.md)
